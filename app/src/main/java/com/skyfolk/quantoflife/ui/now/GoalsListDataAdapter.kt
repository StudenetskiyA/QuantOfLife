...
class QoalsListDataAdapter(private val quantsList: ArrayList<QuantBase>,
                           private val clickListener: (QuantBase) -> Unit,
                           private val longClickListener: (QuantBase) -> Boolean) : RecyclerView.Adapter<QoalsListDataAdapter.ViewHolder>() {
